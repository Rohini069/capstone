  ...
  useEffect(() => {
    if (eventName && eventDescription && eventDate) {
      localStorage.setItem(
        "eventDetails",
        JSON.stringify({ eventName, eventDescription, eventDate })
      );
    }
            ...
            <div className="card">
              <div className="card-body">
                <div className="main-showEvent">
                  ...
                  <p>
                    <strong>Name:</strong>{" "}
                    {eventName || storedEvent?.eventName || "No name available"}
                  </p>
                  <p>
                    <strong>Description:</strong>{" "}
                    {eventDescription ||
                      storedEvent?.eventDescription ||
                      "No description available"}
                  </p>
                  <p>
                    <strong>Date:</strong>{" "}
                    {eventDate || storedEvent?.eventDate || "No date available"}
                  </p>
                </div>
              </div>
            </div>
